...
def write_lines_to_file(
    lines: List[str], filepath: Path, deduplicate: bool = False, sort: bool = False, encoding: str = "utf-8"
) -> int:
    """
    Write lines to file.
...
def write_urls_to_file(
    urls: List[str], filepath: Path, deduplicate: bool = True, sort: bool = False, encoding: str = "utf-8"
) -> int:
    """
    ...
    """
    return write_lines_to_file(urls, filepath, deduplicate=deduplicate, sort=sort, encoding=encoding)
...
def write_to_csv(
    data: List[Dict[str, Any]], filepath: Path, fieldnames: Optional[List[str]] = None, encoding: str = "utf-8"
) -> int:
    """
...
def write_urls_to_csv(
    urls: List[str], filepath: Path, url_column: str = "url", add_index: bool = False, encoding: str = "utf-8"
) -> int:
    """
    ...
    for i, url in enumerate(urls, 1):
        row: dict[str, str | int] = {url_column: url}
        if add_index:
            row["index"] = i
        data.append(row)
...
def write_check_results_to_csv(results: List[Any], filepath: Path, encoding: str = "utf-8") -> int:
    """
...
def write_to_json(data: Any, filepath: Path, indent: int = 2, encoding: str = "utf-8") -> None:
    """
...
def write_results_to_json(
    results: List[Any], filepath: Path, include_summary: bool = True, encoding: str = "utf-8"
) -> None:
    """
    ...
    output = {"results": data_list, "count": len(data_list), "generated_at": datetime.now().isoformat()}
    ...
    if include_summary:
        ...
        output["summary"] = {"total": len(data_list), "by_status": status_counts}
...
def write_domains_to_file(
    domains: List[str], filepath: Path, deduplicate: bool = True, sort: bool = False, encoding: str = "utf-8"
) -> int:
    """
    ...
    """
    return write_urls_to_file(domains, filepath, deduplicate=deduplicate, sort=sort, encoding=encoding)


def append_to_file(lines: List[str], filepath: Path, encoding: str = "utf-8") -> int:
    """
...
def generate_report_file(
    summary: dict, filepath: Path, title: str = "URL Processing Report", encoding: str = "utf-8"
) -> None:
    """
